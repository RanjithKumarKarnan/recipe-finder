...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-[#e9c46a] px-4 py-10">
      <div className="max-w-7xl mx-auto">
        <h1 className="text-center text-4xl font-bold text-[#264653]">
          Recipe Finder
        </h1>

        <p className="text-center text-[#264653] mt-3">
        ...
        <div className="flex justify-center mt-10">
          <input
            ...
            className="w-full md:w-[650px] h-[60px] bg-white rounded-2xl px-6 shadow-md outline-none text-[1rem]"
          />
        </div>
        ...
        {error && (
          <div className="max-w-2xl mx-auto mt-10 bg-[#f4a261] border border-[#e76f51] text-[#264653] px-6 py-4 rounded-2xl shadow-sm">
